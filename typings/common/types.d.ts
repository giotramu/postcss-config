...
export declare type SourceMapOption = ProcessOptions['map'];
export declare type BrowsersOption = string[];
export declare type DebugOption = boolean;
export interface PluginOptions {
    [key: string]: unknown;
}
export declare type Plugin = string | [string, boolean] | [string, PluginOptions];
...
export declare type PostcssPlugins = PluginOptions & Unionize<StandardPlugins>;
